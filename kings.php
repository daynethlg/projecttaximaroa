...
//Perfil*************************************************
include("admin/bd.php");
$sentencia2 = $conexion->prepare("SELECT *FROM `tb_kings_perfil` ");
$sentencia2->execute();
...
//ABOUT THEY*************************************************
include("admin/bd.php");
$sentencia3 = $conexion->prepare("SELECT *FROM `tb_kings_info` ");
$sentencia3->execute();
...
//GALERIA*************************************************
include("admin/bd.php");
$sentencia4 = $conexion->prepare("SELECT *FROM `tb_kings_galeria` ");
$sentencia4->execute();
...
//CONTACTO*************************************************
include("admin/bd.php");
$sentencia5 = $conexion->prepare("SELECT *FROM `tb_kings_datos` ");
$sentencia5->execute();
...
//HORARIO*************************************************
include("admin/bd.php");
$sentencia6 = $conexion->prepare("SELECT *FROM `tb_kings_horario` ");
$sentencia6->execute();
...
//MAPA*************************************************
include("admin/bd.php");
$sentencia7 = $conexion->prepare("SELECT *FROM `tb_kings_mapa` ");
$sentencia7->execute();
...
//ICONO*************************************************
include("admin/bd.php");
$sentencia8 = $conexion->prepare("SELECT *FROM `tb_kings_icono` ");
$sentencia8->execute();
...
<div class="container-fluid col-6">
    <?php foreach ($lista_perfil as $registros2) { ?>
        <img class="mx-auto d-block" src="img/comida/comida_rapida/<?php echo $registros2["imagen"]; ?>" width="250" alt="">
    <?php } ?>
</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 400px;">
                    <div class="position-relative h-100 rounded overflow-hidden">
                        <img class="position-absolute w-100 h-100" src="img/comida/comida_rapida/<?php echo $registros3["imagen"]; ?>" style="object-fit: cover;">
                    </div>
                </div>
            ...
            <?php foreach ($lista_galeria as $registros4) { ?>
                <div class="col-lg-4 col-md-6 p-0 portfolio-item first">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/comida/comida_rapida/<?php echo $registros4["imagen"]; ?>" alt="">
                        <a class="portfolio-btn" href="img/comida/comida_rapida/<?php echo $registros4["imagen"]; ?>" data-lightbox="portfolio">
                    ...
                    <?php foreach ($lista_contacto as $registros5) { ?>
                        ...
                        <?php foreach ($lista_icono as $registros8) { ?>
                            <a href="<?php echo $registros8["link"]; ?>">
                                <img class="social-media" width="80px" src="img/comida/comida_rapida/<?php echo $registros8["imagen"]; ?>" alt="">
                            </a>
                        <?php } ?>
