...
if (isset($_GET['txtid'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tb_nosotros_datos2 WHERE id=:id ");
...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("UPDATE tb_nosotros_datos2  
     SET 
     titulo=:titulo,
    ...
    <div class="card-body">
        ...
        <form action="" enctype="multipart/form-data" method="post">
            ...
            <div class="mb-3">
                ...
                <input value="<?php echo $descripcion; ?>" type="text" class="form-control" name="descripcion" id="descripcion" aria-describedby="helpId" placeholder="" />
            </div>
