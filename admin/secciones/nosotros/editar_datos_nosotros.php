...
if (isset($_GET['txtid'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tb_datos_nosotros WHERE id=:id ");
...
if($_POST) {
    print_r($_POST);
     ...
     $sentencia = $conexion->prepare("UPDATE tb_datos_nosotros  
     SET 
     titulo=:titulo,
    ...
    if ($_FILES["imagen"]["tmp_name"] != "") {
       ...
       //boorado arcjivpo anterior
        $sentencia = $conexion->prepare("SELECT imagen FROM tb_datos_nosotros WHERE id=:id ");
        $sentencia->bindParam(":id", $txtid);
        $sentencia->execute();
