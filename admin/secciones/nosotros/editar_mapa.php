...
if (isset($_GET['txtid'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tb_nosotros_contacto_mapa WHERE id=:id ");
...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("UPDATE tb_nosotros_contacto_mapa  
     SET 
     titulo=:titulo,
     link=:link
    ...
    <div class="card-body">
        ...
        <form action="" enctype="multipart/form-data" method="post">
            ...
            <div class="mb-3">
                ...
                <input value="<?php echo $link; ?>" type="text" class="form-control" name="link" id="link" aria-describedby="helpId" placeholder="" />
            </div>
