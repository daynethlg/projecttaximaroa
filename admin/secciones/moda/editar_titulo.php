...
if (isset($_GET['txtid'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tb_titulo_moda WHERE id=:id ");
...
if($_POST) {
    print_r($_POST);
     ...
     $sentencia = $conexion->prepare("UPDATE tb_titulo_moda  
     SET 
     titulo=:titulo,
    ...
    if ($_FILES["imagen"]["tmp_name"] != "") {
        ...
        move_uploaded_file($tmp_imagen, "../../../img/moda/" . $nombre_archivo_imagen);

    
       //boorado arcjivpo anterior
        $sentencia = $conexion->prepare("SELECT imagen FROM tb_titulo_moda WHERE id=:id ");
        $sentencia->bindParam(":id", $txtid);
        $sentencia->execute();
    ...
    <div class="card-body">
        ...
        <form action="" enctype="multipart/form-data" method="post">
            ...
            <div class="mb-3">
                ...
                <img width="50" src="../../../img/moda/<?php echo $imagen; ?>" />
