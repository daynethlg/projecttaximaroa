...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia = $conexion->prepare("SELECT imagen FROM tb_agonzalez_banner WHERE id=:id ");
    $sentencia->bindParam(":id", $txtid);
    $sentencia->execute();
    $registro_imagen = $sentencia->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen["imagen"])) {
        if (file_exists("../../../../../img/servicios/viajes/agencia_gonzalez/" . $registro_imagen["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/servicios/viajes/agencia_gonzalez/" . $registro_imagen["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia = $conexion->prepare("DELETE FROM tb_agonzalez_banner WHERE id=:id ");
    $sentencia->bindParam(":id", $txtid);
    $sentencia->execute();
}
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia7 = $conexion->prepare("SELECT imagen FROM tb_agonzalez_perfil WHERE id=:id ");
    ...
    //borra registror con ID correspondiente
    $sentencia7 = $conexion->prepare("DELETE FROM tb_agonzalez_perfil WHERE id=:id ");
    $sentencia7->bindParam(":id", $txtid);
    $sentencia7->execute();
}
...
//seleccionar registros
$sentencia7 = $conexion->prepare("SELECT *FROM `tb_agonzalez_perfil`");
$sentencia7->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia9 = $conexion->prepare("SELECT imagen FROM tb_agonzalez_info WHERE id=:id ");
    $sentencia9->bindParam(":id", $txtid);
    $sentencia9->execute();
    $registro_imagen7 = $sentencia9->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen9["imagen"])) {
        if (file_exists("../../../../../img/servicios/viajes/agencia_gonzalez" . $registro_imagen9["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/servicios/viajes/agencia_gonzalez" . $registro_imagen9["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia9 = $conexion->prepare("DELETE FROM tb_agonzalez_info WHERE id=:id ");
    $sentencia9->bindParam(":id", $txtid);
    $sentencia9->execute();
}
...
//seleccionar registros
$sentencia9 = $conexion->prepare("SELECT *FROM `tb_agonzalez_info`");
$sentencia9->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia10 = $conexion->prepare("DELETE FROM tb_agonzalez_info2 WHERE id=:id ");
    $sentencia10->bindParam(":id", $txtid);
    $sentencia10->execute();
}


//seleccionar registros
$sentencia10 = $conexion->prepare("SELECT *FROM `tb_agonzalez_info2`");
$sentencia10->execute();
$lista_info2 = $sentencia10->fetchAll(PDO::FETCH_ASSOC);
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia2 = $conexion->prepare("SELECT imagen FROM tb_agonzalez_galeria WHERE id=:id ");
    $sentencia2->bindParam(":id", $txtid);
    $sentencia2->execute();
    $registro_imagen2 = $sentencia2->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen2["imagen"])) {
        if (file_exists("../../../../../img/servicios/viajes/agencia_gonzalez" . $registro_imagen2["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/servicios/viajes/agencia_gonzalez" . $registro_imagen2["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia2 = $conexion->prepare("DELETE FROM tb_agonzalez_galeria WHERE id=:id ");
    $sentencia2->bindParam(":id", $txtid);
    $sentencia2->execute();
}
...
//seleccionar registros
$sentencia2 = $conexion->prepare("SELECT *FROM `tb_agonzalez_galeria`");
$sentencia2->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia3 = $conexion->prepare("DELETE FROM tb_agonzalez_datos WHERE id=:id ");
    $sentencia3->bindParam(":id", $txtid);
    $sentencia3->execute();
}

//seleccionar registros
$sentencia3 = $conexion->prepare("SELECT *FROM `tb_agonzalez_datos`");
$sentencia3->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia4 = $conexion->prepare("DELETE FROM tb_agonzalez_horario WHERE id=:id ");
    $sentencia4->bindParam(":id", $txtid);
    $sentencia4->execute();
}

//seleccionar registros
$sentencia4 = $conexion->prepare("SELECT *FROM `tb_agonzalez_horario`");
$sentencia4->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia5 = $conexion->prepare("DELETE FROM tb_agonzalez_mapa WHERE id=:id ");
    $sentencia5->bindParam(":id", $txtid);
    $sentencia5->execute();
}

//seleccionar registros
$sentencia5 = $conexion->prepare("SELECT *FROM `tb_agonzalez_mapa`");
$sentencia5->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia6 = $conexion->prepare("SELECT imagen FROM tb_agonzalez_icono WHERE id=:id ");
    $sentencia6->bindParam(":id", $txtid);
    $sentencia6->execute();
    $registro_imagen6 = $sentencia6->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen6["imagen"])) {
        if (file_exists("../../../../img/servicios/viajes/agencia_gonzalez/" . $registro_imagen6["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../img/servicios/viajes/agencia_gonzalez/" . $registro_imagen6["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia6 = $conexion->prepare("DELETE FROM tb_agonzalez_icono WHERE id=:id ");
    $sentencia6->bindParam(":id", $txtid);
    $sentencia6->execute();
}
...
//seleccionar registros
$sentencia6 = $conexion->prepare("SELECT *FROM `tb_agonzalez_icono`");
$sentencia6->execute();
...
<h2>AGENCIA DE VIAJES GONZALEZ</h2>
<!--****************************************BIENVENIDA INICIO************************************************-->
<div class="container">
                    ...
                    <tbody>
                        <?php foreach ($lista_banner as $registros) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/servicios/viajes/agencia_gonzalez/<?php echo $registros['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_perfil as $registros7) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/servicios/viajes/agencia_gonzalez/<?php echo $registros7['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_info as $registros9) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/servicios/viajes/agencia_gonzalez/<?php echo $registros9['imagen']; ?>" />
                                </td>
    ...
    <div class="card">
        <div class="card-header">
            <h1>SOBRE USTEDES 2 parte</h1>
            <a name="" id="" class="btn btn-primary" href="crear_info2.php" role="button">Agregar Registros</a>
                    ...
                    <tbody>
                        <?php foreach ($lista_info2 as $registros10) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col"><?php echo $registros10['id']; ?></td>
                                <td><?php echo $registros10['titulo']; ?></td>
                                <td><?php echo $registros10['descripcion']; ?></td>


                                <td>
                                    <a name="" id="" class="btn btn-info" href="editar_info2.php?txtid=<?php echo $registros10['id']; ?>" role="button">Editar
                                    </a>
                                    <a name="" id="" class="btn btn-danger" href="index.php?txtid=<?php echo $registros10['id']; ?>" role="button">Eliminar
                                    </a>
                    ...
                    <tbody>
                        <?php foreach ($lista_galeria as $registros2) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/servicios/viajes/agencia_gonzalez/<?php echo $registros2['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_icono as $registros6) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/servicios/viajes/agencia_gonzalez/<?php echo $registros6['imagen']; ?>" />
                                </td>
