...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia = $conexion->prepare("SELECT imagen FROM tb_velazquez_banner WHERE id=:id ");
    $sentencia->bindParam(":id", $txtid);
    $sentencia->execute();
    $registro_imagen = $sentencia->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen["imagen"])) {
        if (file_exists("../../../../../img/servicios/musica/dvelazquez/" . $registro_imagen["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/servicios/musica/dvelazquez/" . $registro_imagen["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia = $conexion->prepare("DELETE FROM tb_velazquez_banner WHERE id=:id ");
    $sentencia->bindParam(":id", $txtid);
    $sentencia->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia7 = $conexion->prepare("SELECT imagen FROM tb_velazquez_perfil WHERE id=:id ");
    $sentencia7->bindParam(":id", $txtid);
    $sentencia7->execute();
    $registro_imagen7 = $sentencia7->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen7["imagen"])) {
        if (file_exists("../../../../../img/servicios/musica/dvelazquez/" . $registro_imagen7["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/servicios/musica/dvelazquez/" . $registro_imagen7["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia7 = $conexion->prepare("DELETE FROM tb_velazquez_perfil WHERE id=:id ");
    $sentencia7->bindParam(":id", $txtid);
    $sentencia7->execute();
}
...
//seleccionar registros
$sentencia7 = $conexion->prepare("SELECT *FROM `tb_velazquez_perfil`");
$sentencia7->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia9 = $conexion->prepare("DELETE FROM tb_velazquez_info WHERE id=:id ");
...
//seleccionar registros
$sentencia9 = $conexion->prepare("SELECT *FROM `tb_velazquez_info`");
$sentencia9->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia2 = $conexion->prepare("SELECT imagen FROM tb_velazquez_galeria WHERE id=:id ");
    $sentencia2->bindParam(":id", $txtid);
    $sentencia2->execute();
    $registro_imagen2 = $sentencia2->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen2["imagen"])) {
        if (file_exists("../../../../../img/servicios/musica/dvelazquez" . $registro_imagen2["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/servicios/musica/dvelazquez" . $registro_imagen2["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia2 = $conexion->prepare("DELETE FROM tb_velazquez_galeria WHERE id=:id ");
    $sentencia2->bindParam(":id", $txtid);
    $sentencia2->execute();
}
...
//seleccionar registros
$sentencia2 = $conexion->prepare("SELECT *FROM `tb_velazquez_galeria`");
$sentencia2->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia3 = $conexion->prepare("DELETE FROM tb_velazquez_datos WHERE id=:id ");
    $sentencia3->bindParam(":id", $txtid);
    $sentencia3->execute();
}

//seleccionar registros
$sentencia3 = $conexion->prepare("SELECT *FROM `tb_velazquez_datos`");
$sentencia3->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia5 = $conexion->prepare("DELETE FROM tb_velazquez_mapa WHERE id=:id ");
    $sentencia5->bindParam(":id", $txtid);
    $sentencia5->execute();
}

//seleccionar registros
$sentencia5 = $conexion->prepare("SELECT *FROM `tb_velazquez_mapa`");
$sentencia5->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia6 = $conexion->prepare("SELECT imagen FROM tb_velazquez_icono WHERE id=:id ");
    $sentencia6->bindParam(":id", $txtid);
    $sentencia6->execute();
    $registro_imagen6 = $sentencia6->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen6["imagen"])) {
        if (file_exists("../../../../img/servicios/musica/dvelazquez/" . $registro_imagen6["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../img/servicios/musica/dvelazquez/" . $registro_imagen6["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia6 = $conexion->prepare("DELETE FROM tb_velazquez_icono WHERE id=:id ");
    $sentencia6->bindParam(":id", $txtid);
    $sentencia6->execute();
}
...
//seleccionar registros
$sentencia6 = $conexion->prepare("SELECT *FROM `tb_velazquez_icono`");
$sentencia6->execute();
                    ...
                    <tbody>
                        <?php foreach ($lista_banner as $registros) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/servicios/musica/dvelazquez/<?php echo $registros['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_perfil as $registros7) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/servicios/musica/dvelazquez/<?php echo $registros7['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_galeria as $registros2) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/servicios/musica/dvelazquez/<?php echo $registros2['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_icono as $registros6) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/servicios/musica/dvelazquez/<?php echo $registros6['imagen']; ?>" />
                                </td>
