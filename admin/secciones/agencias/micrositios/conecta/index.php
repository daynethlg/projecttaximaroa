...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia = $conexion->prepare("SELECT imagen FROM tb_conecta_banner WHERE id=:id ");
    ...
    $sentencia = $conexion->prepare("DELETE FROM tb_conecta_banner WHERE id=:id ");
    $sentencia->bindParam(":id", $txtid);
    $sentencia->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia7 = $conexion->prepare("SELECT imagen FROM tb_conecta_perfil WHERE id=:id ");
    $sentencia7->bindParam(":id", $txtid);
    $sentencia7->execute();
    $registro_imagen7 = $sentencia7->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen7["imagen"])) {
        if (file_exists("../../../../../img/agencias/conecta/" . $registro_imagen7["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/agencias/conecta/" . $registro_imagen7["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia7 = $conexion->prepare("DELETE FROM tb_conecta_perfil WHERE id=:id ");
    $sentencia7->bindParam(":id", $txtid);
    $sentencia7->execute();
}
...
//seleccionar registros
$sentencia7 = $conexion->prepare("SELECT *FROM `tb_conecta_perfil`");
$sentencia7->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia9 = $conexion->prepare("SELECT imagen FROM tb_conecta_info WHERE id=:id ");
    $sentencia9->bindParam(":id", $txtid);
    $sentencia9->execute();
    $registro_imagen7 = $sentencia9->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen9["imagen"])) {
        if (file_exists("../../../../../img/agencias/conecta" . $registro_imagen9["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/agencias/conecta" . $registro_imagen9["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia9 = $conexion->prepare("DELETE FROM tb_conecta_info WHERE id=:id ");
    $sentencia9->bindParam(":id", $txtid);
    $sentencia9->execute();
}
...
//seleccionar registros
$sentencia9 = $conexion->prepare("SELECT *FROM `tb_conecta_info`");
$sentencia9->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia2 = $conexion->prepare("SELECT imagen FROM tb_conecta_galeria WHERE id=:id ");
    $sentencia2->bindParam(":id", $txtid);
    $sentencia2->execute();
    $registro_imagen2 = $sentencia2->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen2["imagen"])) {
        if (file_exists("../../../../../img/agencias/conecta" . $registro_imagen2["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/agencias/conecta" . $registro_imagen2["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia2 = $conexion->prepare("DELETE FROM tb_conecta_galeria WHERE id=:id ");
    $sentencia2->bindParam(":id", $txtid);
    $sentencia2->execute();
}
...
//seleccionar registros
$sentencia2 = $conexion->prepare("SELECT *FROM `tb_conecta_galeria`");
$sentencia2->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia3 = $conexion->prepare("DELETE FROM tb_conecta_datos WHERE id=:id ");
    $sentencia3->bindParam(":id", $txtid);
    $sentencia3->execute();
}

//seleccionar registros
$sentencia3 = $conexion->prepare("SELECT *FROM `tb_conecta_datos`");
$sentencia3->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia4 = $conexion->prepare("DELETE FROM tb_conecta_horario WHERE id=:id ");
    $sentencia4->bindParam(":id", $txtid);
    $sentencia4->execute();
}

//seleccionar registros
$sentencia4 = $conexion->prepare("SELECT *FROM `tb_conecta_horario`");
$sentencia4->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia5 = $conexion->prepare("DELETE FROM tb_conecta_mapa WHERE id=:id ");
    $sentencia5->bindParam(":id", $txtid);
    $sentencia5->execute();
}

//seleccionar registros
$sentencia5 = $conexion->prepare("SELECT *FROM `tb_conecta_mapa`");
$sentencia5->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia6 = $conexion->prepare("SELECT imagen FROM tb_conecta_icono WHERE id=:id ");
    $sentencia6->bindParam(":id", $txtid);
    $sentencia6->execute();
    $registro_imagen6 = $sentencia6->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen6["imagen"])) {
        if (file_exists("../../../../img/agencias/conecta/" . $registro_imagen6["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../img/agencias/conecta/" . $registro_imagen6["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia6 = $conexion->prepare("DELETE FROM tb_conecta_icono WHERE id=:id ");
    $sentencia6->bindParam(":id", $txtid);
    $sentencia6->execute();
}
...
//seleccionar registros
$sentencia6 = $conexion->prepare("SELECT *FROM `tb_conecta_icono`");
$sentencia6->execute();
                    ...
                    <tbody>
                        <?php foreach ($lista_banner as $registros) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/agencias/conecta/<?php echo $registros['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_perfil as $registros7) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/agencias/conecta/<?php echo $registros7['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_info as $registros9) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/agencias/conecta/<?php echo $registros9['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_galeria as $registros2) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/agencias/conecta/<?php echo $registros2['imagen']; ?>" />
                                </td>
                    ...
                    <tbody>
                        <?php foreach ($lista_icono as $registros6) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/agencias/conecta/<?php echo $registros6['imagen']; ?>" />
                                </td>
