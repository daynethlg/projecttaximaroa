...
if (isset($_GET['txtid'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tb_agencias_categoria WHERE id=:id ");
...
if($_POST) {
    print_r($_POST);
     ...
     $sentencia = $conexion->prepare("UPDATE tb_agencias_categoria  
     SET 
     titulo=:titulo,
    ...
    if ($_FILES["imagen"]["tmp_name"] != "") {
        ...
        move_uploaded_file($tmp_imagen, "../../../img/agencias/" . $nombre_archivo_imagen);
    ...
    <div class="card-body">
        ...
        <form action="" enctype="multipart/form-data" method="post">
            ...
            <div class="mb-3">
                ...
                <img width="50" src="../../../img/agencias/<?php echo $imagen; ?>" />
