...
if (isset($_GET['txtid'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tb_comida_rapida_categorias WHERE id=:id ");
...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("UPDATE tb_comida_rapida_categorias  
     SET 
     titulo=:titulo,
...
<div class="card">
    ...
    <div class="card-header">
        Editar informacion de categorias
    </div>
