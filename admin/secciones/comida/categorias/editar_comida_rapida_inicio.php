...
if (isset($_GET['txtid'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tb_comida_rapida_inicio WHERE id=:id ");
...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("UPDATE tb_comida_rapida_inicio  
     SET 
     titulo=:titulo
    ...
    if ($_FILES["imagen"]["tmp_name"] != "") {
       ...
       //boorado arcjivpo anterior
        $sentencia = $conexion->prepare("SELECT imagen FROM tb_comida_rapida_inicio WHERE id=:id ");
        $sentencia->bindParam(":id", $txtid);
        $sentencia->execute();
    ...
    <div class="card-body">
        ...
        <form action="" enctype="multipart/form-data" method="post">
            ...
            <div class="mb-3">
                ...
                <img width="50" src="../../../../img/comida/comida_rapida<?php echo $imagen; ?>" />
