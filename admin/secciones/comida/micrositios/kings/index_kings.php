...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia = $conexion->prepare("SELECT imagen FROM tb_kings_banner WHERE id=:id ");
    ...
    $sentencia = $conexion->prepare("DELETE FROM tb_kings_banner WHERE id=:id ");
    $sentencia->bindParam(":id", $txtid);
    $sentencia->execute();
...
$sentencia = $conexion->prepare("SELECT *FROM `tb_kings_banner`");
$sentencia->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia7 = $conexion->prepare("SELECT imagen FROM tb_kings_perfil WHERE id=:id ");
    $sentencia7->bindParam(":id", $txtid);
    $sentencia7->execute();
    $registro_imagen7 = $sentencia7->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen7["imagen"])) {
        if (file_exists("../../../../../img/comida/comida_rapida" . $registro_imagen7["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/comida/comida_rapida" . $registro_imagen7["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia7 = $conexion->prepare("DELETE FROM tb_kings_perfil WHERE id=:id ");
    $sentencia7->bindParam(":id", $txtid);
    $sentencia7->execute();
}
...
//seleccionar registros
$sentencia7 = $conexion->prepare("SELECT *FROM `tb_kings_perfil`");
$sentencia7->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia9 = $conexion->prepare("SELECT imagen FROM tb_kings_info WHERE id=:id ");
    $sentencia9->bindParam(":id", $txtid);
    $sentencia9->execute();
    $registro_imagen7 = $sentencia9->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen9["imagen"])) {
        if (file_exists("../../../../../img/comida/comida_rapida" . $registro_imagen9["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../../img/comida/comida_rapida" . $registro_imagen9["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia9 = $conexion->prepare("DELETE FROM tb_kings_info WHERE id=:id ");
    $sentencia9->bindParam(":id", $txtid);
    $sentencia9->execute();
}
...
//seleccionar registros
$sentencia9 = $conexion->prepare("SELECT *FROM `tb_kings_info`");
$sentencia9->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia2 = $conexion->prepare("SELECT imagen FROM tb_kings_galeria WHERE id=:id ");
    ...
    //borra registror con ID correspondiente
    $sentencia2 = $conexion->prepare("DELETE FROM tb_kings_galeria WHERE id=:id ");
    $sentencia2->bindParam(":id", $txtid);
    $sentencia2->execute();
}
...
//seleccionar registros
$sentencia2 = $conexion->prepare("SELECT *FROM `tb_kings_galeria`");
$sentencia2->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia3 = $conexion->prepare("DELETE FROM tb_kings_datos WHERE id=:id ");
    $sentencia3->bindParam(":id", $txtid);
    $sentencia3->execute();
}

//seleccionar registros
$sentencia3 = $conexion->prepare("SELECT *FROM `tb_kings_datos`");
$sentencia3->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia4 = $conexion->prepare("DELETE FROM tb_kings_horario WHERE id=:id ");
    $sentencia4->bindParam(":id", $txtid);
    $sentencia4->execute();
}

//seleccionar registros
$sentencia4 = $conexion->prepare("SELECT *FROM `tb_kings_horario`");
$sentencia4->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //borra registror con ID correspondiente
    $sentencia5 = $conexion->prepare("DELETE FROM tb_kings_mapa WHERE id=:id ");
    $sentencia5->bindParam(":id", $txtid);
    $sentencia5->execute();
}

//seleccionar registros
$sentencia5 = $conexion->prepare("SELECT *FROM `tb_kings_mapa`");
$sentencia5->execute();
...
if (isset($_GET['txtid'])) {
    ...
    //imagen
    $sentencia6 = $conexion->prepare("SELECT imagen FROM tb_kings_icono WHERE id=:id ");
    $sentencia6->bindParam(":id", $txtid);
    $sentencia6->execute();
    $registro_imagen6 = $sentencia6->fetch(PDO::FETCH_LAZY);

    if (isset($registro_imagen6["imagen"])) {
        if (file_exists("../../../../img/comida/comida_rapida/" . $registro_imagen6["imagen"])) {
            echo "Imagen enconconyrada...";
            unlink("../../../../img/comida/comida_rapida/" . $registro_imagen6["imagen"]);
        }
    }


    //borra registror con ID correspondiente
    $sentencia6 = $conexion->prepare("DELETE FROM tb_kings_icono WHERE id=:id ");
    $sentencia6->bindParam(":id", $txtid);
    $sentencia6->execute();
}
...
//seleccionar registros
$sentencia6 = $conexion->prepare("SELECT *FROM `tb_kings_icono`");
$sentencia6->execute();
...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h1>Banner</h1>
            <a name="" id="" class="btn btn-primary" href="crear_kings_banner.php" role="button">Agregar Registros</a>
                    ...
                    <tbody>
                        <?php foreach ($lista_banner as $registros) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/comida/comida_rapida/<?php echo $registros['imagen']; ?>" />
                                </td>
                               
                                
                                <td>
                                    <a name="" id="" class="btn btn-info" href="editar_kings_banner.php?txtid=<?php echo $registros['id']; ?>" role="button">Editar
                                    </a>
                                    <a name="" id="" class="btn btn-danger" href="index_kings.php?txtid=<?php echo $registros['id']; ?>" role="button">Eliminar
                                    </a>
...
<br>
    ...
    <div class="card">
        <div class="card-header">
            <h1>Perfil</h1>
            <a name="" id="" class="btn btn-primary" href="crear_kings_perfil.php" role="button">Agregar Registros</a>
                    ...
                    <tbody>
                        <?php foreach ($lista_perfil as $registros7) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/comida/comida_rapida/<?php echo $registros7['imagen']; ?>" />
                                </td>
                               
                                
                                <td>
                                    <a name="" id="" class="btn btn-info" href="editar_kings_perfil.php?txtid=<?php echo $registros7['id']; ?>" role="button">Editar
                                    </a>
                                    <a name="" id="" class="btn btn-danger" href="index_kings.php?txtid=<?php echo $registros7['id']; ?>" role="button">Eliminar
                                    </a>
                    ...
                    <tbody>
                        <?php foreach ($lista_info as $registros9) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/comida/comida_rapida/<?php echo $registros9['imagen']; ?>" />
                                </td>
                                ...
                                <td>
                                    ...
                                    <a name="" id="" class="btn btn-danger" href="index_kings.php?txtid=<?php echo $registros9['id']; ?>" role="button">Eliminar
                                    </a>
                    ...
                    <tbody>
                        <?php foreach ($lista_galeria as $registros2) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/comida/comida_rapida/<?php echo $registros2['imagen']; ?>" />
                                </td>
                                ...
                                <td>
                                    ...
                                    <a name="" id="" class="btn btn-danger" href="index_kings.php?txtid=<?php echo $registros2['id']; ?>" role="button">Eliminar
                                    </a>
                        ...
                        <?php foreach ($lista_datos as $registros3) { ?>
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <a name="" id="" class="btn btn-danger" href="index_kings.php?txtid=<?php echo $registros3['id']; ?>" role="button">Eliminar</a>
                        ...
                        <?php foreach ($lista_horario as $registros4) { ?>
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <a name="" id="" class="btn btn-danger" href="index_kings.php?txtid=<?php echo $registros4['id']; ?>" role="button">Eliminar</a>
                        ...
                        <?php foreach ($lista_mapa as $registros5) { ?>
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <a name="" id="" class="btn btn-danger" href="index_kings.php?txtid=<?php echo $registros5['id']; ?>" role="button">Eliminar</a>
                    ...
                    <tbody>
                        <?php foreach ($lista_icono as $registros6) { ?>
                            ...
                            <tr class="">
                                ...
                                <td scope="col">
                                    <img width="50" src="../../../../../img/comida/comida_rapida/<?php echo $registros6['imagen']; ?>" />
                                </td>

                                <td>
                                    <a name="" id="" class="btn btn-info" href="editar_icono.php?txtid=<?php echo $registros6['id']; ?>" role="button">Editar
                                    </a>
                                    <a name="" id="" class="btn btn-danger" href="index_kings.php?txtid=<?php echo $registros6['id']; ?>" role="button">Eliminar
                                    </a>
