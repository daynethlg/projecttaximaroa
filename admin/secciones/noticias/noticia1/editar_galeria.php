...
if (isset($_GET['txtid'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tb_noticias_galeria WHERE id=:id ");
...
if($_POST) {
    print_r($_POST);
     ...
     $sentencia = $conexion->prepare("UPDATE tb_noticias_galeria 
     SET 
     titulo=:titulo,
    ...
    <div class="card-body">
        ...
        <form action="" enctype="multipart/form-data" method="post">
            ...
            <div class="mb-3">
                ...
                <img width="50" src="../../../../img/noticias/noticia1/<?php echo $imagen; ?>" />
            ...
            <a name="" id="" class="btn btn-primary" href="index_noticia1.php" role="button">Cancelar</a>
