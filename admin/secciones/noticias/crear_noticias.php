...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("INSERT INTO `tb_noticias` (`id`, `imagen`, `titulo`, `descripcion`, `categoria`, `fecha`, `boton`) 
    VALUES (NULL,  :imagen, :titulo, :descripcion, :categoria, :fecha, :boton);");
